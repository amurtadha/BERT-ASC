...
class Instructor:
    ...
    def _train(self, optimizer,criterion, train_data_loader, val_data_loader, t_total):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(tqdm(train_data_loader)):
                ...
                outputs= self.model(input_ids, token_type_ids, attention_mask, labels)
    ...
    def run(self):
        ...
        best_model_path = self._train(optimizer,criterion, train_data_loader, val_data_loader, t_total)
