...
class Instructor:
    def __init__(self, opt):
        ...
        if self.opt.dataset=='semeval':
            ...
            self.valset =self.testset
            # self.valset = ABSADataset_absa_bert_sentihood_json(opt.dataset_file['val'], tokenizer, opt)
    ...
    def run(self):
        ...
        # path = 'state_dict/{0}/{0}_seed_{1}.bm'.format( self.opt.semeval, str(self.opt.seed))
